<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SalesManLogin.aspx.vb" Inherits="LiveCisPortal.SalesManLogin" %>
...
<body>
    <form id="form1" runat="server">
        <div align="center" class="container-fluid">
                    ...
                    <tbody align="center">
                        <tr>
                            <td style="padding: 5px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="UserName" ForeColor="#ff0000" Text="Το πεδίο ΑΦΜ είναι υποχρεωτικό!"></asp:RequiredFieldValidator>
                            ...
                            <td style="padding: 5px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="PassWord" ForeColor="#ff0000" Text="Το πεδίο Κωδικός είναι υποχρεωτικό!"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
            ...
            <br />
            <br />
            <div runat="server" class="alert alert-danger" style="visibility: hidden" id="bootalert" role="alert">
                Λάθος Αφμ η κωδικός <%--<a href="#" class="alert-link">an example link</a>--%>
            </div>
