            ...
            <Items>
                <dx:LayoutGroup Caption="Πεδία Παραγγελίας" ColCount="2" Width="70%" GroupBoxDecoration="Box" HorizontalAlign="Center" VerticalAlign="Middle">
                    <Items>
                        ...
                        <dx:LayoutItem FieldName="Τύπος" Width="50%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxTextBox ID="txtDocType" ReadOnly="true" runat="server" Width="50%">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem FieldName="Περιγρ" Width="50%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxTextBox ID="txtDocDescr" runat="server" Width="50%">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem FieldName="Κωδ. Πελ.">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer Width="100%" ID="LayoutItemNestedControlContainer3" runat="server" SupportsDisabledAttribute="True">
                                    <div style="float: left; width: 50%; margin-right: 1%; margin-top: 5.5%">
                                        <dx:ASPxTextBox ID="txtPersonCode" OnTextChanged="txtPersonCode_TextChanged" AutoPostBack="true" runat="server">
                                        </dx:ASPxTextBox>
                                    </div>
                                    <div style="float: left; width: 10%; margin-left: 5%; margin-bottom: 1%">
                                        <LP:BtnSelector ID="BtnSelector1" DoPostBack="javascript:__doPostBack('MainContent_ASPxFormLayout1_txtPersonCode_I', '');" runat="server" BackColor="#42f4e8" ButtonCssClass="Large material-icons prefix pulse" ClassValue="search" DialogTitle="Some Title" lookupTable="PerCategory" PostAtOK="True" TargetTextId="MainContent_ASPxFormLayout1_txtPersonCode_I" TooltipText="Έπεξεργασία πίνακα Κατηγορίας Συναλ/μένου" />
                                    </div>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem FieldName="Ον/επών" Width="50%">
                            <LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutItem FieldName="Κωδικός">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer6" runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxTextBox ID="txtCode" runat="server" Width="50%">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem FieldName="Ημ/νία" CaptionCellStyle-Paddings-PaddingLeft="1px">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer7" runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxDateEdit runat="server" ID="DateDD" Width="50%"></dx:ASPxDateEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                            <CaptionCellStyle>
                        ...
                        <dx:LayoutItem FieldName="ΦΠΑ">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer8" runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxTextBox ID="txtFpa" runat="server" Width="50%">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
