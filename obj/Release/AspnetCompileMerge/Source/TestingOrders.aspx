<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TestingOrders.aspx.vb" MasterPageFile="~/SiteSide.Master" Inherits="LiveCisPortal.TestingOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <dx:LayoutGroup Caption="Πεδία Παραγγελίας" ColCount="2" Width="70%" GroupBoxDecoration="Box" HorizontalAlign="Center" VerticalAlign="Middle">
                    <Items>
                        ...
                        <dx:LayoutItem FieldName="Ημ/νία" CaptionCellStyle-Paddings-PaddingLeft="1px">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxDateEdit runat="server" EnableViewState="true" ID="DateDD"></dx:ASPxDateEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                            <CaptionCellStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSourceline" runat="server"
        ConnectionString="<%$ ConnectionStrings:ComvoiceDemoConnectionString2 %>"
