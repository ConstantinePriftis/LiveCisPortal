// jsgrid custom build from 2015-10-24T14:50:36.658Z
// Selected modules: external/jquery.fmatter.js, js/grid.custom.js, js/grid.common.js, js/grid.formedit.js, js/grid.filter.js, js/grid.inlinedit.js, js/grid.celledit.js, external/jqModal.js, external/jqDnR.js, js/grid.subgrid.js, js/grid.grouping.js, js/grid.treegrid.js, js/grid.pivot.js, js/grid.import.js, external/JsonXml.js, js/grid.tbltogrid.js, js/grid.jqueryui.js
// Default locale: i18n/grid.locale-el.js
		...
		populate = function (npage) {
			...
			if(!gridSelf.hDiv.loading) {
				...
				if (p.url != null && p.datatype != 'local') {
                    var detectFormat = function (data) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                p.datatype = null;
                                throw 'invalid or malformed data.';
                            }
                        }
                    },
                    ...
                    if ((typeof p.url == 'string' || p.url instanceof String) && (p.url.substr(0, 1) === '/' || p.url.substr(0, 4) === 'http')) {
                        $.ajax($.extend({
                            url: p.url,
                            type: p.mtype,
                            data: $.isFunction(p.serializeGridData) ? p.serializeGridData.call(self, p.postData) : p.postData,
                            success: function (data, st, xhr) {
                                if ($.isFunction(p.beforeProcessing) && p.beforeProcessing.call(self, data, st, xhr) === false) {
                                    endReq.call(self);
                                    return;
                                }
                            ...
                            error: function (xhr, st, err) {
                                if ($.isFunction(p.loadError)) {
                                    p.loadError.call(self, xhr, st, err);
                                }
                                if (npage === 1) {
                                    endReq.call(self);
                                }
                            ...
                            beforeSend: function (xhr, settings) {
                                if ($.isFunction(p.loadBeforeSend) && p.loadBeforeSend.call(self, xhr, settings) === false){
                                    return false;
                                }
                                beginReq.call(self);
                            }
                    ...
                    switch (dt) {
                        ...
                        case "jsonstring":
                            beginReq.call(self);
                            if (typeof p.datastr === 'string') {
                                dstr = $.jgrid.parse(p.datastr);
                            } else {
                                dstr = p.datastr;
                            }
